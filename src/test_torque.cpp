...
//
	typedef boost::tuple<jt_type, jp_type, jv_type, jt_type> tuple_type;
	typedef systems::TupleGrouper<jt_type, jp_type, jv_type, jt_type> tg_type;
	tg_type tg;
...
//
	...
	const double JT_AMPLITUDE = 0.2; // N*m
